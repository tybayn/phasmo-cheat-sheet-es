...
function create_room(){
    ...
    fetch(`https://zero-network.net/phasmophobia/create-room/${znid}?lang=${lang}`,{method:"POST",Accept:"application/json",body:JSON.stringify(outgoing_state),signal: AbortSignal.timeout(6000)})
